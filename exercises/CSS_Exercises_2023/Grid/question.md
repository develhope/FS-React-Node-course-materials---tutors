Guarda il layout nell'immagine di esempio (start/example.png nel file zip disponibile al download) e cerca di replicarlo utilizzando le proprietà CSS Grid.
